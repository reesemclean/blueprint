...
import { IUserInput, expandFolderPath, DynamicTemplateValues } from "../src/inputs";
...
suite("Extension Tests", () => {
    ...
    const runTestForTemplateNamed = async (templateName: string, dynamicTemplateValues: DynamicTemplateValues) => {
